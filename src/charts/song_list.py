    ...
    *,
    ...
    table = dash_table.DataTable(
        ...
        style_cell_conditional=[
            ...
            {"if": {"column_id": "track_name"}, "width": "146px", "minWidth": "146px", "maxWidth": "146px"},
            {"if": {"column_id": "artists"}, "width": "172px", "minWidth": "172px", "maxWidth": "172px"},
            {"if": {"column_id": "track_genre"}, "width": "96px", "minWidth": "96px", "maxWidth": "96px"},
            {"if": {"column_id": "popularity"}, "width": "88px", "minWidth": "88px", "maxWidth": "88px"},
            {"if": {"column_id": "energy"}, "width": "70px", "minWidth": "70px", "maxWidth": "70px"},
            {"if": {"column_id": "valence"}, "width": "70px", "minWidth": "70px", "maxWidth": "70px"},
            {"if": {"column_id": "danceability"}, "width": "82px", "minWidth": "82px", "maxWidth": "82px"},
        ],
